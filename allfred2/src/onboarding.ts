...
export default dialogue('Onboarding ', (fbid: string) => [
    ...
    expect`I want to know about:`, {
        ...
        'Deposits ': (text: string) => {console.log(`The user choose ${text}`);return goto`deposit1`},
    },
    `cards`,
    ask`Choose one type of cards`,
    ...
    `shopping`,
    ask`Choose one type of shopping cards`,
    expect`I want to know :shopping cards`, {
    ...
    `flying`,
    ask`Choose what you want to know`,
    expect`User asks`, {
    ...
    `more`,
    ask`Do you want to know more about BT Flying Blue card?`,
    expect`user want to know`, {
   ...
   expect`I want to know more about start card`, {
   ...
   expect `I want to know about star`, {
       ...
       expect`I want to know star forte`, {
   ...
   expect `I want to know star gold`, {
       ...
       expect`I want to know about Star Gold`, {
   ...
   expect `I want to know the following`, {
       ...
       expect`I want to know platinium `, {
           'Yes': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`starGold` },
           'No,Thank you': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`finish` }, 
           'I want to know more about Star Forte': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`starForte` },
           'I want to know more about Star Gold': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`starGold` },
   ...
   'debitCards',
   ask`Choose one topic of your interest`,
   expect`I want to know about debit card`, {
       ...
       expect `I want to know electron`, {
           ...
           `suitVisaElectron`,
               ...
               `moreVisaElectron`,
                   ...
                   expect`I want to know about Visa Electron`, {
       ...
       expect `I want to know gold`, {
           ...
           `suitMasterCardGoldDebit`,
               ...
               `moreMasterCardGoldDebit`,
                   ...
                   expect`I want to know in particular`, {
                   'Yes': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`masterCardMondo` },
                   'No, Thank you': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`finish` }, 
                   'I want to know more about Visa Electron': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`visaElectron` },
                   'I want to know more about MasterCard Mondo': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`masterCardMondo` },
       ...
       expect `I want to knowdirect `, {
           ...
           `suitMasterCardDirect`,
               ...
               `moreMasterCardDirect`,
                   ...
                   expect`I want to know masterdirect `, {
                   'Yes': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`masterCardMondo` },
                   'No,Thank you': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`finish` }, 
                   'I want to know more about Visa Electron': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`visaElectron` },
                   'I want to know more about MasterCard Mondo': (text: string) =>{ console.log(`The user needs more info about ${text}`); return goto`masterCardMondo` },
  ...
  ask `What do you want to know about Savings Account`,
   expect `I want to know savings`, {
       'Required documents': (text: string) => { console.log(`The user wants to know more about ${text}`); return goto`docm1` },
       ...
       'How much does it cost to get my deposit back?': (text: string) => {console.log(`The user needs info about ${text}`); return goto`feecost1` },
       },
    ...
    expect`I want to know more this`, {
  ...
  ask `What do you want to know about Term Deposits?`,
   expect `I want to know term`, {
       ...
       'Required documents': (text: string) => { console.log(`The user wants to know more about ${text}`); return goto`docm2` },
       ...
       'How much does it cost to get my deposit back?': (text: string) => {console.log(`The user needs info about ${text}`); return goto`feecost2` },
       },
    `minterm`,
 ...
 `first`,
    ...
    expect`I want to `, {
        'Make a deposit': (text: string) => { console.log(`The user want to ${text}`); return goto`deposit2` },
